...
public class BookWindowGUI extends JFrame {
        ...
        validateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    bookToAdd.setPeerUid(listPeers.get(comboBoxLibrary.getSelectedIndex()).getUid());
                    ...
                    for (Author author : authorDataModel.getListAuthors()) {
                        author.setPeerUid(listPeers.get(comboBoxLibrary.getSelectedIndex()).getUid());
                    ...
                    for (Genre genre : genreDataModel.getListGenres()) {
                        ...
                        newLink.setPeerUid(listPeers.get(comboBoxLibrary.getSelectedIndex()).getUid());
                    ...
                    for (Character character : characterDataModel.getListCharacters()) {
                        character.setPeerUid(listPeers.get(comboBoxLibrary.getSelectedIndex()).getUid());
    ...
    public BookWindowGUI(Book bookToUpdate) {
        ...
        try {
            ...
            {
                if(myPeer.getUid().equals(bookToUpdate.getPeerUid()))
                {
            ...
            if(bookToUpdate.linkedGenre != null)
            {
                ...
                for(int i = 0; i < bookToUpdate.linkedGenre.length; i++)
                {
                    ...
                    myGenre.setPeerUid(bookToUpdate.getPeerUid());
        ...
        validateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    if(bookToModify.getPeerUid().equals(listPeers.get(comboBoxLibrary.getSelectedIndex()).getUid()))
                    {
                    ...
                    else
                    {
                        ...
                        newBook.setPeerUid(listPeers.get(comboBoxLibrary.getSelectedIndex()).getUid());
        ...
        autofillButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    StringBuilder listCondition = new StringBuilder();
                    listCondition.append(manager.getObjectVariable(new Book())+" fb:type.object.name '"+formattedTextFieldTitle.getText()+"'@en.\n");
                    listCondition.append("FILTER ( lang(?title) =  'en' ).\n");
                    listCondition.append("FILTER ( lang(?summary) = 'en' )");

                    List<Book> listBook = manager.listAllWithQueryString(new Book(), listCondition.toString(), null);

                    //If the first matching didn't succeed
                    if(listBook.size() == 0)
                    {
                        //2nd try : regex matching (Quite slow)
                        listCondition = new StringBuilder();
                        listCondition.append(manager.getObjectVariable(new Book())+" fb:type.object.name ?nameToFind");
                        listCondition.append("FILTER regex(str(?nameToFind), '"+formattedTextFieldTitle.getText()+"', 'i')");
                        listCondition.append("FILTER ( lang(?title) =  'en' )");
                        listCondition.append("FILTER ( lang(?summary) = 'en' )");

                        listBook = manager.listAllWithQueryString(new Book(), listCondition.toString(), null);
                    }
